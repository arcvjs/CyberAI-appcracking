...
Open [the final PowerPoint](../../final-dist/Presentation/App-Cracking-12-Slides.pptx), or use the [saved Canva presentation](https://www.canva.com/design/DAHUlXUeEFM/BJSNGnTt-4JgDcrqgoROgw/edit). The 12-slide deck uses Bahasa Indonesia with English technical terms. Canva pages are full-slide images; the PowerPoint retains editable text and speaker notes.
...
node src/Exhibition-Deck/scripts/build.mjs
```
